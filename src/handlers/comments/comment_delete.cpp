...
userver::formats::json::Value Handler::HandleRequestJsonThrow(
    ...
    const auto result_find_comment = GetPg().Execute(
        userver::storages::postgres::ClusterHostType::kMaster, sql::kFindCommentByIdAndSlug.data(), comment_id, slug
    );
    ...
    const auto result_delete_comment = GetPg().Execute(
        userver::storages::postgres::ClusterHostType::kMaster, sql::kDeleteCommentById.data(), comment_id, user_id
    );
