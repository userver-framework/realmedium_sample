...
public:
    ValidationException(std::string_view field, std::string_view msg) : BaseType(MakeError(field, msg)) {}

    explicit ValidationException(userver::formats::json::Value&& json) : BaseType(std::move(json)) {}
};
